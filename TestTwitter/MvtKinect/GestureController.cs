...
namespace MvtKinect
{
    public class GestureController
    {
        ...
        public GestureController()
        {
            ...
            swipeUpSegments[0] = new SwipeUp1();
            swipeUpSegments[1] = new SwipeUp2();
            swipeUpSegments[2] = new SwipeUp3();
            AddGesture(GestureType.SwipeUp, swipeUpSegments);


            IRelativeGestureSegment[] swipeDownSegments = new IRelativeGestureSegment[3];
            swipeDownSegments[0] = new SwipeUp3();
            swipeDownSegments[1] = new SwipeUp2();
            swipeDownSegments[2] = new SwipeUp1();
            AddGesture(GestureType.SwipeDown, swipeDownSegments);

            IRelativeGestureSegment[] swipeUpGaucheSegments = new IRelativeGestureSegment[3];
            swipeUpGaucheSegments[0] = new SwipeUpGauche1();
            swipeUpGaucheSegments[1] = new SwipeUpGauche2();
            swipeUpGaucheSegments[2] = new SwipeUpGauche3();
            AddGesture(GestureType.SwipeUpLeft, swipeUpGaucheSegments);

            IRelativeGestureSegment[] swipeDownGaucheSegments = new IRelativeGestureSegment[3];
            swipeDownGaucheSegments[0] = new SwipeUpGauche3();
            swipeDownGaucheSegments[1] = new SwipeUpGauche2();
            swipeDownGaucheSegments[2] = new SwipeUpGauche1();
            AddGesture(GestureType.SwipeDownLeft, swipeDownGaucheSegments);
